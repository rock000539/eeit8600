...
<body>
	<form action="/games/update" method="post">
		<table>
			<tr>
				<td>編號 :</td>
				<td><input type="text" name="id" value="${game.id}" readonly></td>
				<td></td>
			</tr>
			<tr>
				<td>名稱 :</td>
			...
			<tr>
				<td>評價 :</td>
				<td><input type="text" name="evalu" value="${game.evaluation}"></td>
				<td style="color: red;">${errorMsg.evalu}</td>
			</tr>
			<tr>
				<td>下載量 :</td>
				<td><input type="text" name="dl" value="${game.download}"></td>
				<td style="color: red;">${errorMsg.dl}</td>
			</tr>
			<tr>
				<td>連結 :</td>
				<td><input type="text" name="url" value="${game.url}"></td>
