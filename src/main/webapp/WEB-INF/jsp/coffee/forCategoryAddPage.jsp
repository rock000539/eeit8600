...
---------------------------------------------    
    <form>
  <table>
<tr><td><input type="text" name="id" value="">ID</td><td>${errorMsg.Id}</td></tr>
<tr><td><input type="text" name="name" value="">名字</td><td>${errorMsg.Name}</td></tr>
<tr><td><input type="text" name="local" value="">產地</td><td>${errorMsg.Local}</td></tr>
<tr><td><input type="text" name="price" value="">價錢</td><td>${errorMsg.Price}</td></tr>
<tr><td><input type="text" name="testing" value="">試用</td><td>${errorMsg.Testing}</td></tr>
</table><br>
