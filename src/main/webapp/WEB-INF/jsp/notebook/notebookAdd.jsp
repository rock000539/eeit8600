...
<title>Notebooks Add</title>
</head>
<body>
<h2>Notebooks Add</h2>
	<form action="/notebooks/insert" method="post">
		<table>
			<tr>
				<td>品牌</td>
				<td><input type="text" name="brand" value="${param.brand}"></td>
			...
			<tr>
				<td>中央處理器</td>
				<td><input type="text" name="cpu" value="${param.cpu}"></td>
