    ...
    $(document).ready(function(){
        ...
        (function() {
            ...
            $(window).on("load resize orientationchange",function(e){
                ...
                $("canvas").detach().appendTo('#rainy-container'); // Append Rainy Canvas to #rainy-container

                $(".home #rainy-container").height($(".slider").height() + $("#header").height());

                if($( window ).width() < 768){
                    $("#logo").detach().appendTo($(".navbar-header"));
                }
                else{
                    $("#logo").detach().appendTo('#logo-bar')
                }
            });
        })();
